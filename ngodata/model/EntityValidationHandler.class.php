 ...
 * This is the validation handler for Entity
 * - this validates and keeps track of error messages for Entity objects.
...
class EntityValidationHandler {
	// this holds the details of the field validation for Entity objects.
	private $validationRules = array(
		'entity_name'=>array('required'),
