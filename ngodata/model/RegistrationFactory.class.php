...
require_once '../model/RegistrationValidationHandler.class.php';
 ...
 * This is the factory for Registration
 * - this creates and sets Registration objects.
...
class RegistrationFactory {
	 ...
	 * Method created automatically by NGOData system
	 */
	public function createRegistrationById($id) {
		$qo = new RegistrationQO();
		// set the where
		$item = array('id'=>$id);
		$qo->setWhere($item);
	 ...
	 * Method created automatically by NGOData system
	 */
	public function createRegistration(iPostData $data) {
		echo '<pre>';
		print 'in createRegistration: ';
		echo '</pre>';
		...
		$vo->setData($data);
		$vo->setQueryObject($qo);
		$dao = new RegistrationDAO($this->getSQLFactory());
		$dao->setValueObject($vo);
		return $dao;
	}
	...
	public function validate($validationArray) {
		...
		//business_name needs validating.
		//required are required tests.
		//business_registration_code needs validating.
		//required are required tests.
		//email needs validating.
		//required|email are required tests.
		//title_id needs validating.
		//required|numeric are required tests.
		//firstname needs validating.
		//required are required tests.
		//surname needs validating.
		//required are required tests.
	}
	 ...
	 * - Assumes $obj exists in persistent storage.
	 */
	public function doDelete(RegistrationDAO $obj) {
		// do some magic...
