 ...
 * This is the validation handler for User
 * - this validates and keeps track of error messages for User objects.
...
class UserValidationHandler {
	// this holds the details of the field validation for User objects.
